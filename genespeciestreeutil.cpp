...
int GeneSpeciesTreeUtil::LabelInternalNodesUniquely(Node* tree)
{
    vector<Node*> v;
    v.push_back(tree);
    int cpt = LabelInternalNodesUniquely(v);
    return cpt;
}

int GeneSpeciesTreeUtil::LabelInternalNodesUniquely(vector<Node*> trees)
{
    int cpt = 0;
